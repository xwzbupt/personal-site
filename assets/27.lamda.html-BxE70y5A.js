...
<span class="line"><span>  return a + b;</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里稍微总结一下，不同的编程范式之间并不是截然不同的，总是有一些相同的编程规则。比如，不管是面向过程、面向对象还是函数式编程，它们都有变量、函数的概念，最顶层都要有main函数执行入口，来组装编程单元（类、函数等）。只不过，面向对象的编程单元是类或对象，面向过程的编程单元是函数，函数式编程的编程单元是无状态函数。</p><p>接下来，我们就看下Java这种面向对象编程语言，对函数式编程的支持。我们先来看下面这样一段非常典型的Java函数式编程的代码。这段代码的作用是，先过滤除非空字符串，然后再查找以“wz-”为前缀的字符串，最后统计每个字符串的长度，并打印输出。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>public class FPDemo {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果你不了解Java函数式编程的语法，看了上面的代码或许会有些懵，主要的原因是，Java为函数式编程引入了4个新的语法：函数接口（Functional Inteface）、Lambda表达式、方法引用、Stream流。函数接口的作用是让我们可以把函数包裹成接口（interface），来实现把函数当做参数一样来使用（Java不像C一样支持函数指针，可以把函数直接当参数来使用）；引入Lambda表达式的作用是简化函数接口的匿名实现类的代码编写；方法引用的作用是进一步简化Lambda表达式；Stream流用来支持通过“.”级联多个函数操作的代码编写方式。接下来，我们就一一详细讲解一下这4个语法。</p><h2 id="二、函数接口" tabindex="-1"><a class="header-anchor" href="#二、函数接口"><span><strong>二、函数接口</strong></span></a></h2><p>我们知道，C语言支持函数指针，它可以把函数直接当变量来使用。但是，Java没有函数指针这样的语法。所以，它通过函数接口，将函数包裹在接口中，当作变量来使用。比如，我们经常使用的Runnable、Comparator等都是函数接口，代码如下所示。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>@FunctionalInterface</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>跟自定义异常、自定义注解一样，我们也可以自定义函数接口。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>@FunctionalInterface</span></span>
<span class="line"><span>public interface Filter&lt;T&gt; {</span></span>
<span class="line"><span>  boolean accept(T name);</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然，只有函数接口的定义是没有意义的，我们还要有代码用到它，函数接口的使用如下示例所示。从作用上，函数接口有点类似《设计模式之美》中讲到的模板模式，从实现上，函数接口有点类似《设计模式之美》中讲到的回调。将某个流程中可变的逻辑抽离出来，设计成函数接口，以此来支持灵活定制可变逻辑。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>public class Demo {</span></span>
<span class="line"><span>  public static void main(String[] args) {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>看到这里，你可能会说，Runnable、Comparator这种只包含一个未实现方法的接口早就有了，为什么在JDK8引入函数式编程时，将它们重新定义为函数接口呢？它们在函数式编程中有什么特殊作用呢？函数接口为什么只能允许包含一个未实现的接口呢？要回答这些问题，我们就要先了解Lambda表达式。</p><h2 id="三、lambda表达式" tabindex="-1"><a class="header-anchor" href="#三、lambda表达式"><span><strong>三、Lambda表达式</strong></span></a></h2><p>我们前面讲到，Java引入Lambda表达式的主要作用是简化代码编写，但凡用到函数接口的地方，我们都可以将函数接口的匿名实现类替换成Lambda表达式。如上示例代码所示，我们将<code>Filter&lt;T&gt;</code>的匿名实现类替换为Lambda表达式，如下所示。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>public static void main(String[] args) {</span></span>
<span class="line"><span>  List&lt;String&gt; files = Arrays.asList(&quot;wang.txt&quot;, &quot;zheng.java&quot;, &quot;xiao.txt&quot;, &quot;ge.java&quot;);</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    return name.endsWith(&quot;.java&quot;);</span></span>
<span class="line"><span>  });</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Lambda表达式包括三部分：输入、函数体、输出。如下所示。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>(类型 a, 类型 b) -&gt; { 语句1； 语句2；...; return 输出; } //a,b是输入参数</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>实际上，Lambda表达式的写法非常灵活。我们刚刚给出的是标准写法，还有很多简化写法。比如，我们可以将输入参数的类型省略，由编译器自行推测。如果输入参数只有一个，还可以省略()，直接写成a-&gt;{...}；如果没有入参，可以直接将输入和箭头都省略掉，只保留函数体；如果函数体只有一个语句，那么还可以将{}和return关键词省略掉。</p><p>按照以上省略规则，我们将上述示例代码中的Lamba表达式简化，简化之后的代码如下所示。从这里我们也可以得知，Lambda表达式只是为了简化代码比较简单的匿名实现类。当匿名实现类中只包含一条语句时，简化效果最好。如果匿名实现类中代码逻辑比较复杂，那么使用Lambda表达式的简化效果就不明显了。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>List&lt;String&gt; javaFiles = filterFiles(files, name-&gt;name.endsWith(&quot;.java&quot;));</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>如果我们把以下Lambda表达式，全部替换为函数接口的实现方式，如下所示。对比来看，代码是不是多了很多？</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>// 使用Lambda表达式，非常简洁</span></span>
...
<span class="line"><span>      }</span></span>
<span class="line"><span>    });</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>了解了Lambda表达式之后，我们就可以回答之前遗留的问题了。函数接口本质上就是接口，没有什么新颖的，在函数式编程出现之前就已经存在并且大量使用。抽象出函数接口这个概念，完全是新瓶装旧酒，目的是希望对能够简写为Lambda表达式的这一类接口有一个统一的称谓，方便沟通。那么，函数接口为什么只能包含一个未实现的方法呢？这里主要有两个原因，其一是：函数接口的目的是为了能把函数（也就是方法）当做参数来传递，在这里，函数是主角，一个函数理应包裹为一个单独的函数接口，一个函数接口内不应该有两个主角。其二是：因为只有包含一个未实现的方法，简化之后的Lambda表达式才能明确知道匹配的是哪个方法。如果函数接口包含两个未实现的方法，并且方法入参、返回值都一样，那么，Java在翻译Lambda表达式时，就无法知道表达式对应哪个方法了。</p><h2 id="四、方法引用" tabindex="-1"><a class="header-anchor" href="#四、方法引用"><span><strong>四、方法引用</strong></span></a></h2><p>当Lambda中的逻辑已经有现成的方法实现时，我们可以直接使用方法引用。需要注意的是，方法引用要求所引用的方法的参数列表和返回值，跟函数接口中未实现方法的参数列表和返回值完全一致。方法引用的语法格式如下所示。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>对象::实例方法</span></span>
<span class="line"><span>类::静态方法</span></span>
<span class="line"><span>类::实例方法</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,41)),p("p",null,[s[0]||(s[0]=a("比如下列示例中就用到了两个方法引用，String")),t(i,{icon:"isEmpty和String"}),s[1]||(s[1]=a("length。当然，我们也可以不使用方法引用，如注释中所示。"))]),s[3]||(s[3]=n(`<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>public class FPDemo {</span></span>
<span class="line"><span>  public static void main(String[] args) {</span></span>
<span class="line"><span>    List&lt;String&gt; strList = Arrays.asList(&quot;wz-a.java&quot;, &quot;wz-b.txt&quot;, &quot;c.java&quot;);</span></span>
<span class="line"><span>    strList.stream()</span></span>
<span class="line"><span>        .filter(((Predicate&lt;String&gt;) String::isEmpty).negate())</span></span>
...
<span class="line"><span>        .forEach(l-&gt;System.out.println(l));  //输出9、8</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="五、stream流" tabindex="-1"><a class="header-anchor" href="#五、stream流"><span><strong>五、Stream流</strong></span></a></h2><p>实际上，上面讲到的函数接口、Lambda表达式，只是函数式编程中的辅助语法，真正体现函数式编程其“函数”本质的应该是Stream流。接下来，我们就来讲一讲Stream流。</p><p>假设我们要计算这样一个表达式：(3-1)*2+5。如果按照普通的函数调用的方式写出来，就是下面这个样子的。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>add(multiply(subtract(3,1),2),5);</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>不过，这样编写的代码可读性比较差，我们换个可读性更好的写法，如下所示。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>subtract(3,1).multiply(2).add(5);</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>我们知道，在Java中，“.”表示调用某个对象上的方法。为了支持上面这种级联调用方式，我们让每个函数都返回一个通用的类型：Stream对象。在Stream上的操作有两种：中间操作和终止操作。中间操作返回的仍然是Stream对象，而终止操作返回的是确定的值结果或者没有返回值。</p><p>我们再来看之前的例子。我对代码做了注释解释，如下所示。其中，map、filter是中间操作，返回Stream对象，可以继续级联其他操作；forEach()是终止操作，没有返回值，无法再继续往下级联处理了。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>public class FPDemo {</span></span>
<span class="line"><span>  public static void main(String[] args) {</span></span>
<span class="line"><span>    List&lt;String&gt; strList = Arrays.asList(&quot;wz-a.java&quot;, &quot;wz-b.txt&quot;, &quot;c.java&quot;);</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Stream中的filter()、map()、forEach()等方法的参数为Java预定义的函数接口，如下所示，因此，函数接口的匿名实现类可以通过Lambda表达式来简化，如上示例代码所示。除了filter()、map()、forEach()之外，Stream类中还定义了很多其他操作，你可以自行查看java.util.stream.Stream的源码。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>Stream&lt;T&gt; filter(Predicate&lt;? super T&gt; predicate);</span></span>
<span class="line"><span>&lt;R&gt; Stream&lt;R&gt; map(Function&lt;? super T, ? extends R&gt; mapper);</span></span>
<span class="line"><span>void forEach(Consumer&lt;? super T&gt; action);</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>前面提到，在Java预定义的函数接口中，不仅仅包含未实现的方法，还包含一些具有默认实现的方法，比如<code>Predicate&lt;T&gt;</code>函数接口中的and()、or()、negatef()等方法，那么，这些具有默认实现的方法到底是做什么用的呢？实际上，它们一般用来组合操作，我举个例子，你就清楚了。示例代码如下所示，我们希望过滤得到既包含前缀“wz-”，又包含后缀“.java”的字符串，这里我们就可以使用<code>Predicate&lt;T&gt;</code>中的and()操作。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>List&lt;String&gt; strList = Arrays.asList(&quot;wz-a.java&quot;, &quot;wz-b.txt&quot;, &quot;c.java&quot;);</span></span>
