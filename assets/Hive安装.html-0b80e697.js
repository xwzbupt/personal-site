...
stop-all.sh
start-all.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到这里安装Hive就结束了，可以尝试使用Hive。</p>`,24);function H(D,O){const s=r("ExternalLinkIcon");return t(),d("div",null,[c,n("p",null,[e("Hadoop安装包下载地址："),n("a",p,[e("清华大学开源软件镜像站"),i(s)])]),v,n("p",null,[e("这里做单节点配置，可以参考"),n("a",m,[e("官网配置"),i(s)]),e("。")]),u,n("p",null,[e("Hive安装包下载地址："),n("a",b,[e("清华大学镜像站"),i(s)])]),h,n("p",null,[n("a",g,[e("创建hive-env.sh"),i(s)]),e("，将conf目录下的"),k,e("复制一份并重命名为"),f,e("。")]),x,n("p",null,[n("a",_,[e("下载地址"),i(s)]),e("。下载后将其传到``/usr/local/hive/apache-hive-3.1.3-bin/lib`下。")]),y])}const S=l(o,[["render",H],["__file","Hive安装.html.vue"]]);export{S as default};
