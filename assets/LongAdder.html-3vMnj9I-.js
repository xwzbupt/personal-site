import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as l,o as e}from"./app-Pk7jsT-x.js";const i={};function p(c,s){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="累加器" tabindex="-1"><a class="header-anchor" href="#累加器"><span><strong>累加器</strong></span></a></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>如何使用数据分片、哈希优化、去伪共享提高累加器性能？</strong></p></div><p>前面几节中，我们讲到锁、自旋+CAS、原子类。对于如下代码，如果我们希望将其改造成线程安全的，那么该如何来做呢？</p><div class="language-" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>public class Counter {</span></span>
