import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,d as l}from"./app-f06160db.js";const d={},s=l(`<h1 id="累加器" tabindex="-1"><a class="header-anchor" href="#累加器" aria-hidden="true">#</a> <strong>累加器</strong></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>如何使用数据分片、哈希优化、去伪共享提高累加器性能？</strong></p></div><p>前面几节中，我们讲到锁、自旋+CAS、原子类。对于如下代码，如果我们希望将其改造成线程安全的，那么该如何来做呢？</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class Counter {
  private long sum;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="六、思考题" tabindex="-1"><a class="header-anchor" href="#六、思考题" aria-hidden="true">#</a> <strong>六、思考题</strong></h2><p>如果我们希望LongAdder的sum()函数能给出准确、一致的累加和，该如何对LongAdder的代码进行改造？改造之后的代码对性能又有什么影响？</p>`,55),a=[s];function r(c,u){return n(),i("div",null,a)}const o=e(d,[["render",r],["__file","LongAdder.html.vue"]]);export{o as default};
