import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,c as l,d as i}from"./app.931b505c.js";const d={},s=i(`<h1 id="累加器" tabindex="-1"><a class="header-anchor" href="#累加器" aria-hidden="true">#</a> <strong>累加器</strong></h1><div class="custom-container tip"><p class="custom-container-title">提示</p><p><strong>如何使用数据分片、哈希优化、去伪共享提高累加器性能？</strong></p></div><p>前面几节中，我们讲到锁、自旋+CAS、原子类。对于如下代码，如果我们希望将其改造成线程安全的，那么该如何来做呢？</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class Counter {
  private long sum;
