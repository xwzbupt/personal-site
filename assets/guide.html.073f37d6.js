import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as l,e as n,f as s,b as e,d as p,r as c}from"./app.9c046361.js";const o={},u=p(`<h1 id="本站搭建步骤" tabindex="-1"><a class="header-anchor" href="#本站搭建步骤" aria-hidden="true">#</a> 本站搭建步骤</h1><h2 id="一、安装node-js" tabindex="-1"><a class="header-anchor" href="#一、安装node-js" aria-hidden="true">#</a> <strong>一、安装Node.js</strong></h2><div class="custom-container tip"><p class="custom-container-title">提示</p><p>安装node.js是在CentOS7上的步骤，在windows的环境下同理，安装后需要配置环境变量。</p><p>建议安装最新的LTS版本的Node.js</p></div><ol><li>下载node</li></ol><p><strong>必须安装12以上的版本，这里我选择了最新的LTS版本，v16</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://registry.npmmirror.com/-/binary/node/v16.15.0/node-v16.15.0-linux-x64.tar.gz
