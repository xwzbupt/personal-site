...
footer: >-
  <div class="home-footer">
    <div class="home-footer__grid">
      ...
      <section class="home-footer__section">
        <h2>🚀 强力驱动</h2>
        <div class="home-footer__links">
          <a href="https://vuejs.press/" target="_blank" rel="noopener noreferrer">VuePress</a>
          <a href="https://theme-hope.vuejs.press/zh/" target="_blank" rel="noopener noreferrer">Theme Hope</a>
      ...
      <section class="home-footer__section">
        <h2>🧭 站内导航</h2>
        <div class="home-footer__links">
          <a href="/home.html">项目主页</a>
          <a href="/about/guide.html">关于本站</a>
          <a href="/about/cv.html">个人简历</a>
        </div>
      </section>
      <section class="home-footer__section">
        <h2>🤝 友情链接</h2>
